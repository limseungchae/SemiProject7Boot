package seung.springboot.semiprojectv7.utils;
...
public class GalleryUtils {
    ...
    public void makeThumbnail(GalAttach ga, Object uuid) {
        ...
        // 썸네일 이미지 경로 정의
        String thumbname = saveImgDir + "_thubs/small_" + basename;

        System.out.println(refname + "," + thumbname);

        try {
            // 원본이미지를 잀어서 메모리에 이미지객체(캔버스)를 생성
